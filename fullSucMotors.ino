...
#define CH_GRIPPER     3   // ← كان 4، بقى 3 بعد حذف WRIST_ROLL
#define NUM_SERVOS     4   // ← كان 5
...
// ← حذفنا سطر WRIST_ROLL من الـ array
...
// ============================================================
//  ✅ التعديل: moveRight و moveLeft → جانب واحد بيقف والتاني لقدام
// ============================================================
void moveRight() {
  // اليمين بيقف، الشمال بيروح لقدام
  ledcWrite(0, 0);             // EN_RIGHT → وقف
  ledcWrite(1, currentSpeed);  // EN_LEFT  → شغال
  digitalWrite(R1_IN1,LOW);  digitalWrite(R1_IN2,LOW);   // يمين وقف
  digitalWrite(R2_IN1,LOW);  digitalWrite(R2_IN2,LOW);
  digitalWrite(L1_IN1,HIGH); digitalWrite(L1_IN2,LOW);   // شمال لقدام
  digitalWrite(L2_IN1,HIGH); digitalWrite(L2_IN2,LOW);
}
void moveLeft() {
  // الشمال بيقف، اليمين بيروح لقدام
  ledcWrite(0, currentSpeed);  // EN_RIGHT → شغال
  ledcWrite(1, 0);             // EN_LEFT  → وقف
  digitalWrite(R1_IN1,HIGH); digitalWrite(R1_IN2,LOW);   // يمين لقدام
  digitalWrite(R2_IN1,HIGH); digitalWrite(R2_IN2,LOW);
  digitalWrite(L1_IN1,LOW);  digitalWrite(L1_IN2,LOW);   // شمال وقف
  digitalWrite(L2_IN1,LOW);  digitalWrite(L2_IN2,LOW);
}
// ============================================================
