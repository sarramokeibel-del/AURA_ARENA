...
// -- Zigzag Thresholds (330x330mm cells, 20mm walls)
// *** TUNE_HERE: adjust these if robot overshoots or undershoots ***
#define DIST_STOP   10   // cm: emergency reverse
#define DIST_WARN   18   // cm: start turning
#define DIST_CLEAR  22   // cm: confirm path clear after turn
#define TURN_MS    800   // ms: 90-degree pivot duration - tune by trial
#define REVERSE_MS 350   // ms: reverse duration before turning
...
void setup() {
  Serial.begin(115200);
  delay(300);
  Serial.println("=== ROBOT STARTED - ZIGZAG MODE ===");
  Serial.printf("STOP=%dcm WARN=%dcm CLEAR=%dcm TURN=%dms\n", DIST_STOP, DIST_WARN, DIST_CLEAR, TURN_MS);
